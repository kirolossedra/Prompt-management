...
export const ACHIEVEMENTS: readonly AchievementDefinition[] = [
  ...
  },
  {
    ...
    description: "Use IntellectVault on 7 distinct calendar days. The days do not need to be consecutive.",
  ...
  },
  {
    ...
    description: "Use IntellectVault on 30 distinct calendar days. The days do not need to be consecutive.",
    category: "Consistency",
    icon: "calendar",
    target: 30,
    progressLabel: countLabel("active days"),
