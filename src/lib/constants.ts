...
export const FINALIZED_DECISIONS = [
  ...
  ["Prompt duplication", "Prompts", "Duplicate creates a new independent Prompt with its own history; visible Copy remains a clipboard operation."],
  ...
  ["Prompt Mixer", "AI", "A user can combine two or more Prompt source windows into one editable AI-generated candidate. Each source can be loaded from the vault or pasted/typed ad hoc; the result can be discarded, saved as a new Prompt, or intentionally saved as the next version of an existing Prompt."],
  ...
  ["Prompt Blocks", "AI", "Prompt Blocks is a typed, deterministic Prompt-transformation DAG with reusable saved pipelines, inspectable intermediate values, explicit constraint priority, and editable database-backed transformation prompts."],
